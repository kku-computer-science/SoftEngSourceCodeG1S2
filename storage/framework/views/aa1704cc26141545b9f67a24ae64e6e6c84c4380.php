...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <?php if($res->doctoral_degree == 'Ph.D.'): ?>
                            <h6 class="card-text"><b><?php echo e($res->fname_en); ?> <?php echo e($res->lname_en); ?>, <?php echo e($res->doctoral_degree); ?>
                        ...
                        <?php $__currentLoopData = $res->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h6 class="card-text2 col-sm-10"> <?php echo e($edu->year); ?> <?php echo e($edu->qua_name); ?>

                                <?php echo e($edu->uname); ?></h6>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="scholar-tab" data-bs-toggle="tab" data-bs-target="#scholar" type="button"
                    role="tab" aria-controls="scholar" aria-selected="false">Google Scholar</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="tab-content" style="padding-bottom: 20px;">
                    <a class="btn btn-success" href="<?php echo e(route('excel', ['id' => $res->id])); ?>" target="_blank">Export To
                        Excel</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $__currentLoopData = $paper->source; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span>
                                            <a><?php echo e($s->source_name); ?><?php if(!$loop->last): ?>
                                                    ,
                                                <?php endif; ?>
                                            </a>
                                        </span>
            ...
            <div class="tab-pane fade" id="orcid" role="tabpanel" aria-labelledby="orcid-tab">
                <table id="example3" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $papers_orcid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n => $paper): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td> <?php echo e($n + 1); ?></td>
                                <td><?php echo e($paper->paper_yearpub); ?></td>
                                <!-- <td style="width:90%;"><?php echo e($paper->paper_name); ?></td> -->
    ...
    <script type="text/javascript">
        ...
        async function myFunction() {
            ...
            const response = await fetch('https://api.elsevier.com/content/search/author?query=authlast(' + res
                .lname_en +

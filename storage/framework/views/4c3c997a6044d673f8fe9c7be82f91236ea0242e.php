            ...
            <div class="d-flex">
                <div class="ml-auto">
                    <form class="row row-cols-lg-auto g-3" method="GET"
                        action="<?php echo e(route('searchresearchers', ['id' => $res->id])); ?>">
                        <div class="col-md-8">
                        ...
                        <div class="card mb-3">
                            <div class="row g-0">
                                ...
                                <div class="col-sm-8 overflow-hidden"
                                    style="text-overflow: clip; <?php if(app()->getLocale() == 'en'): ?> max-height: 220px; <?php else: ?> max-height: 210px; <?php endif; ?>">
                                    <div class="card-body">
                                        <?php if(app()->getLocale() == 'en'): ?>
                                            <?php if($r->doctoral_degree == 'Ph.D.'): ?>
                                                <h5 class="card-title"><?php echo e($r->{'fname_' . app()->getLocale()}); ?>

                                                    <?php echo e($r->{'lname_' . app()->getLocale()}); ?>, <?php echo e($r->doctoral_degree); ?>

                                                <?php else: ?>
                                                    <h5 class="card-title"><?php echo e($r->{'fname_' . app()->getLocale()}); ?>

                                                        <?php echo e($r->{'lname_' . app()->getLocale()}); ?></h5>
                                            <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <h5 class="card-title"><?php echo e($r->{'position_' . app()->getLocale()}); ?>
                                                ...
                                                <?php echo e($r->{'fname_' . app()->getLocale()}); ?>

                                                <?php echo e($r->{'lname_' . app()->getLocale()}); ?>
